...
export default function Footer  ({ route}) {
    ...
    <View style={styles.container}>
       ...
       <Text style={{position:'absolute', fontSize:30,zIndex:10,color:'transparent', left:'47%'}} onPress={()=>navigation.navigate('Trees')}>T</Text>
        <Image source={Leaderboard} style={{position:'relative',  height:'50%', width:'10%', resizeMode:'contain', marginVertical:'2.5%', paddingHorizontal:'10%'}}></Image>
        <Text style={{position:'absolute', fontSize:30,zIndex:10,color:'transparent', left:'67%'}} onPress={()=>navigation.navigate('Login')}>L</Text>
        ...
        <Text style={{position:'absolute', fontSize:30,zIndex:10,color:'transparent', left:'87%'}} onPress={()=>navigation.navigate('Login')}>P</Text>
